<?php
	class M_fr_mma extends CI_Model{
		...
		public 3_1_KARAKTERISTIK_PESERTA;
		public 3_1_PENYESUAIAN_KEBUTUHAN_SPESIFIK;
		public 3_2_PADA_BATASAN_VARIABEL;
		public 3_2_PADA_PANDUAN_PENILAIAN;
		public 3_3;
		public 3_3_CATATAN;
		public 3_4;
		public 3_4_CATATAN;
		...
		public function insert_entry($form_name)
			{
				...
				$this->3_1_KARAKTERISTIK_PESERTA	= (!$this->input->post($form_name[207]) ? null : $this->input->post($form_name[207]));
				$this->3_1_PENYESUAIAN_KEBUTUHAN_SPESIFIK	= (!$this->input->post($form_name[208]) ? null : $this->input->post($form_name[208]));
				$this->3_2_PADA_BATASAN_VARIABEL 	= (!$this->input->post($form_name[209]) ? null : $this->input->post($form_name[209]));
				$this->3_2_PADA_PANDUAN_PENILAIAN 	= (!$this->input->post($form_name[210]) ? null : $this->input->post($form_name[210]));
				$this->3_3 							= (!$this->input->post($form_name[211]) ? null : $this->input->post($form_name[211]));
				$this->3_3_CATATAN 					= (!$this->input->post($form_name[212]) ? null : $this->input->post($form_name[212]));
				$this->3_4 							= (!$this->input->post($form_name[213]) ? null : $this->input->post($form_name[213]));
				$this->3_4_CATATAN 					= (!$this->input->post($form_name[214]) ? null : $this->input->post($form_name[214]));
				$this->3_5 							= (!$this->input->post($form_name[215]) ? null : $this->input->post($form_name[215]));
				$this->3_5_CATATAN 					= (!$this->input->post($form_name[216]) ? null : $this->input->post($form_name[216]));
				$this->3_6 							= (!$this->input->post($form_name[217]) ? null : $this->input->post($form_name[217]));
				$this->3_6_CATATAN 					= (!$this->input->post($form_name[218]) ? null : $this->input->post($form_name[218]));
		...
		public function update_entry($form_name, $data, $condition)
			{
				...
				$this->UUID_APL_01 					= (!$this->input->post($form_name[134]) ? null : $this->input->post($form_name[134]));
				$this->UUID_APL_02 					= (!$this->input->post($form_name[146]) ? null : $this->input->post($form_name[146]));
				$this->NO_DOKUMEN 					= (!$this->input->post($form_name[180]) ? null : $this->input->post($form_name[180]));
				$this->KELOMPOK_TARGET_1 			= (!$this->input->post($form_name[181]) ? null : $this->input->post($form_name[181]));
				$this->KELOMPOK_TARGET_2 			= (!$this->input->post($form_name[182]) ? null : $this->input->post($form_name[182]));
				$this->TUJUAN_ASESMEN 				= (!$this->input->post($form_name[183]) ? null : $this->input->post($form_name[183]));
				$this->KONTEKS_ASESMEN_1 			= (!$this->input->post($form_name[184]) ? null : $this->input->post($form_name[184]));
