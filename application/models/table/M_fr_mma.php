		...
		public function update_entry($form_name, $data, $condition)
			{
				...
				$this->STRATEGI_ASESMEN 			= (!$this->input->post($form_name[190]) ? $data->STRATEGI_ASESMEN : implode(',', $this->input->post($form_name[190])));
				$this->ACUAN_PEMBANDING 			= (!$this->input->post($form_name[191]) ? $data->ACUAN_PEMBANDING : implode(',', $this->input->post($form_name[191])));
				$this->ACUAN_PEMBANDING_KETERANGAN 	= (!$this->input->post($form_name[192]) ? $data->ACUAN_PEMBANDING_KETERANGAN : $this->input->post($form_name[192]));
				$this->BATASAN_VARIABEL 			= (!$this->input->post($form_name[193]) ? $data->BATASAN_VARIABEL : $this->input->post($form_name[193]));
				$this->PANDUAN_ASESMEN 				= (!$this->input->post($form_name[194]) ? $data->PANDUAN_ASESMEN : $this->input->post($form_name[194]));
				$this->PERSETUJUAN_ASESOR 			= (!$this->input->post($form_name[195]) ? $data->PERSETUJUAN_ASESOR : $this->input->post($form_name[195]));
				$this->PERSETUJUAN_ASESOR_DTM 		= (!$this->input->post($form_name[196]) ? $data->PERSETUJUAN_ASESOR_DTM : $this->input->post($form_name[196]));
				$this->PERSETUJUAN_PENYEDIA 		= (!$this->input->post($form_name[197]) ? $data->PERSETUJUAN_PENYEDIA : $this->input->post($form_name[197]));
				$this->PERSETUJUAN_PENYEDIA_DTM 	= (!$this->input->post($form_name[198]) ? $data->PERSETUJUAN_PENYEDIA_DTM : $this->input->post($form_name[198]));
				$this->PERSETUJUAN_TUK 				= (!$this->input->post($form_name[199]) ? $data->PERSETUJUAN_TUK : $this->input->post($form_name[199]));
				$this->PERSETUJUAN_TUK_DTM 			= (!$this->input->post($form_name[200]) ? $data->PERSETUJUAN_TUK_DTM : $this->input->post($form_name[200]));
				...
				$this->STRATEGI_KOMUNIKASI 			= (!$this->input->post($form_name[220]) ? $data->STRATEGI_KOMUNIKASI : $this->input->post($form_name[220]));
				$this->KOORDINATOR_TUK 				= (!$this->input->post($form_name[221]) ? $data->KOORDINATOR_TUK : $this->input->post($form_name[221]));
				$this->KOORDINATOR_TUK_DTM 			= (!$this->input->post($form_name[222]) ? $data->KOORDINATOR_TUK_DTM : $this->input->post($form_name[222]));
				$this->MANAGER_SERTIFIKASI_LSP 		= (!$this->input->post($form_name[223]) ? $data->MANAGER_SERTIFIKASI_LSP : $this->input->post($form_name[223]));
				$this->MANAGER_SERTIFIKASI_LSP_DTM 	= (!$this->input->post($form_name[224]) ? $data->MANAGER_SERTIFIKASI_LSP_DTM : $this->input->post($form_name[224]));
				$this->MANAGER_TEMPAT_KERJA 		= (!$this->input->post($form_name[225]) ? $data->MANAGER_TEMPAT_KERJA : $this->input->post($form_name[225]));
				$this->MANAGER_TEMPAT_KERJA_DTM 	= (!$this->input->post($form_name[226]) ? $data->MANAGER_TEMPAT_KERJA_DTM : $this->input->post($form_name[226]));
				...
				$this->PENYUSUN_RENCANA_DTM 		= (!$this->input->post($form_name[229]) ? $data->PENYUSUN_RENCANA_DTM : $this->input->post($form_name[229]));
				...
				$this->MANAGER_SERTIFIKASI_DTM 		= (!$this->input->post($form_name[232]) ? $data->MANAGER_SERTIFIKASI_DTM : $this->input->post($form_name[232]));
