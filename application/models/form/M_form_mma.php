	...
	public function form_edit($data, $form_name, $result)
		{
			...
			$data[$form_name[207]] 	= $result->3_1_KARAKTERISTIK_PESERTA;
			$data[$form_name[208]] 	= $result->3_1_PENYESUAIAN_KEBUTUHAN_SPESIFIK;
			$data[$form_name[209]] 	= $result->3_2_PADA_BATASAN_VARIABEL;
			$data[$form_name[210]] 	= $result->3_2_PADA_PANDUAN_PENILAIAN;
			$data[$form_name[211]] 	= $result->3_3;
			$data[$form_name[212]] 	= $result->3_3_CATATAN;
			$data[$form_name[213]] 	= $result->3_4;
			$data[$form_name[214]] 	= $result->3_4_CATATAN;
			$data[$form_name[215]] 	= $result->3_5;
			$data[$form_name[216]] 	= $result->3_5_CATATAN;
			$data[$form_name[217]] 	= $result->3_6;
			$data[$form_name[218]] 	= $result->3_6_CATATAN;
