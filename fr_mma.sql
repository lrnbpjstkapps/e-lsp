...
CREATE TABLE IF NOT EXISTS `fr_mma` (
  ...
  `3_1_KARAKTERISTIK_PESERTA` varchar(500) DEFAULT NULL,
  `3_1_PENYESUAIAN_KEBUTUHAN_SPESIFIK` varchar(500) DEFAULT NULL,
  `3_2_PADA_BATASAN_VARIABEL` varchar(255) DEFAULT NULL,
  `3_2_PADA_PANDUAN_PENILAIAN` varchar(255) DEFAULT NULL,
  `3_3` varchar(50) DEFAULT NULL,
  `3_3_CATATAN` varchar(255) DEFAULT NULL,
  `3_4` varchar(50) DEFAULT NULL,
  `3_4_CATATAN` varchar(255) DEFAULT NULL,
  `3_5` varchar(50) DEFAULT NULL,
  `3_5_CATATAN` varchar(255) DEFAULT NULL,
  `3_6` varchar(50) DEFAULT NULL,
  `3_6_CATATAN` varchar(255) DEFAULT NULL,
